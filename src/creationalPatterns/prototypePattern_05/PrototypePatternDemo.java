 ...
 * in mind. This type of design pattern comes under creational pattern as this
 ...
 * is costly. For example, an object is to be created after a costly database
 * operation. We can cache the object, returns its clone on next request and update
